...
def record_selection(
    ...
    entry = {
        ...
        "scenario": {
            ...
            "escalation_pattern": scenario.get("escalation_pattern", ""),
            "climax_type": scenario.get("climax_type", ""),
            "climax_description": scenario.get("climax_description", ""),
            "aftermath_type": scenario.get("aftermath_type", ""),
            "aftermath_description": scenario.get("aftermath_description", ""),
